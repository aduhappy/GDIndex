...
(function () {
  ...
  exports.getEncodedMessage = exports.b64encode = exports.b64encodeJSON = exports.getDERfromPEM = exports.str2ab = exports.atob = void 0;

  var _base64url = _interopRequireDefault(base64url);
  ...
  const b64encodeJSON = obj => _base64url.default.encode(str2ab(JSON.stringify(obj)));

  exports.b64encodeJSON = b64encodeJSON;
  const b64encode = _base64url.default.encode;
  ...
  unwrapExports(utils);
  var utils_1 = utils.getEncodedMessage;
  var utils_2 = utils.b64encode;
  var utils_3 = utils.b64encodeJSON;
  var utils_4 = utils.getDERfromPEM;
  var utils_5 = utils.str2ab;
  var utils_6 = utils.atob;
  ...
  exports.getTokenFromGCPServiceAccount = exports.getToken = exports.getHeader = void 0;
  ...
  const getToken = async ({
    ...
    const privateKeyDER = (0, utils.getDERfromPEM)(privateKeyPEM);
    ...
    const encodedMessage = (0, utils.getEncodedMessage)(header, payload);
    const encodedMessageArrBuf = (0, utils.str2ab)(encodedMessage);
    const signatureArrBuf = await crypto.subtle.sign(algorithms.RS256.name, privateKey, encodedMessageArrBuf);
    const encodedSignature = (0, utils.b64encode)(signatureArrBuf);
  ...
  unwrapExports(jwt);
  var jwt_1 = jwt.getTokenFromGCPServiceAccount;
  var jwt_2 = jwt.getToken;
  var jwt_3 = jwt.getHeader;

  const { getToken, getTokenFromGCPServiceAccount } = jwt;

  var workersJwt = { getToken, getTokenFromGCPServiceAccount };
  var workersJwt_2 = workersJwt.getTokenFromGCPServiceAccount;
